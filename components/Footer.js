        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mb-2">
              📞 <a href="tel:+919896416786" className="hover:text-white">+91 9896416786</a><br/>
              ✉️ <a href="mailto:shreeshyam.com" className="hover:text-white">shreeshyamjewellers15@gmail.com</a><br/>
